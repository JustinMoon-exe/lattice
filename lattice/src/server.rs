...
impl ChainService {
    ...
    async fn get_direct_transfer(
        ...
        Some(QuoteResult {
            ...
            requires_approval: false, // transfer() is called by the sender directly
...
mod tests {
    ...
    // Tested as a live integration test below (requires RPC).
    ...
    async fn live_usdc_direct_transfer_base() {
        ...
        // amount_out_min == amount_in for a direct transfer (no slippage)
